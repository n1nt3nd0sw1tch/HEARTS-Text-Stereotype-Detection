...
train_model(train_data_rubist_second, model_path='', batch_size=64, epoch=6, learning_rate=2e-5, model_output_base_dir='model_output_rubert_second', dataset_name='rubist_second_trained', seed=42)
